  ...
  return (
    <div className="w-full">
      ...
      <aside
        ...
        className={`fixed top-0 right-0 h-screen w-[50%] max-w-sm z-50 bg-white dark:bg-black shadow transition-transform duration-500 ease-in-out transform md:hidden

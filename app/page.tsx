      ...
      <main className="py-10 flex justify-center items-center max-w-7xl mx-auto gap-20 px-10 flex-col">
        ...
        >
          ...
          <figcaption className="flex justify-between items-center flex-col ">
            ...
            <p className="text-center py-3 xl:text-lg text-sm font-medium capitalize">
              ...
              Artificial Intelligence. I developed a strong interest in web
              development three years ago and have been actively pursuing it
              ever since.
            </p>
          </figcaption>
          <button
        ...
        >
          ...
          <p className="py-7 text-sm">
            I’m currently focused on building more projects to further enhance
            my frontend skills, with a strong interest in learning unit testing
            and advanced SEO optimization techniques. Additionally, I aim to
            deepen my backend expertise with Node.js by developing more complex
            full-stack applications. My goal is to explore advanced
            architectural patterns, particularly using Next.js, to become a more
            well-rounded and efficient developer.
          </p>
          <p className="py-7 text-sm">
            I am currently open to frontend development opportunities, with
            strong expertise in React and Next.js. I also have a solid
            background in Angular, having explored its core deeply and enjoyed
            its powerful architecture. I’m eager to contribute to impactful
            projects and grow within a collaborative development team.
          </p>
            ...
            {skills.map((skill, idx) => {
              return (
                ...
                >
                  ...
                  />
                  <h3 className={`${poppins.className} text-center`}>
                    {skill.header}
                  </h3>
                  <p
            ...
            {projects.map((project, idx) => (
              <div className="grid grid-cols-1 gap-5 items-start" key={idx}>
                ...
                <article className={`${inter.className}`}>
                  <h3 className={`${poppins.className} font-bold`}>
                    {project.header}
                  </h3>
